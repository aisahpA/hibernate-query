...
public class HSQL_Util {
    ...
    private static Logger logger = Logger.getLogger( HSQL_Util.class );

    public static final int PORT = 9002;
    public static final String DB_NAME = "cxg";       //数据库文件名，同时也是本类中的数据库名
    ...
    public static void main(String[] args) {
        ...
        try {
            Statement statement = getConnection().createStatement();
            statement.executeUpdate("create table customer(id integer not null primary key,firstname varchar(255),lastname varchar(255))");
            for (int i = 10; i < 20; i++) {
